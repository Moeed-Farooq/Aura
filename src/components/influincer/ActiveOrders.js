...
const ActiveOrders = () => {
  ...
  const completedOrders = [
    { projectName: 'Order 1',projectImg: orderImg,status:"Delivery",result:"in process" , projectDescription: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est officiis veritatis error quis vel ipsa dolor doloremque odio animi ea!' },
    { projectName: 'Order 1',projectImg: orderImg, status:"Delivery",result:"in process" ,projectDescription: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est officiis veritatis error quis vel ipsa dolor doloremque odio animi ea!' },
    { projectName: 'Order 1',projectImg: orderImg,status:"Delivery",result:"in process" , projectDescription: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est officiis veritatis error quis vel ipsa dolor doloremque odio animi ea!' },
    { projectName: 'Order 1',projectImg: orderImg,status:"Delivery",result:"in process" , projectDescription: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est officiis veritatis error quis vel ipsa dolor doloremque odio animi ea!' },
    { projectName: 'Order 1',projectImg: orderImg,status:"Delivery",result:"in process" , projectDescription: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est officiis veritatis error quis vel ipsa dolor doloremque odio animi ea!' },
      ...
      <div className="main-container">
        <div className="container-fluid m-0 p-0">
          <div className="row pt-4 px-4 d-flex">
            <p style={{ fontSize: "20px", fontWeight: "500" }}>Active Orders</p>
