      ...
      <div className="main-container">
        <div className="container-fluid m-0 p-0 ">
          ...
          <div className="row main-labels mx-5">
            ...
            <div className="col-md-2"><p>Time</p></div>
            <div className="col-md-2 text-end"><p>Report</p></div>
          ...
          {[...Array(showCount)].map((_, index) => (
            <Link className='Link' to="/UserStatusReport" key={index}><HomeCard {...propsdata} /></Link>
          ))}
          {/* main footer */}
