...
const Chat = ({ searchTerm }) => {
  ...
  return (
    <div className='Chat-Container px-3' style={{ height: '230px', width: '100%', overflowY: 'auto' }}>
    {selectedChat ? (
          ...
          <div className="row chatContainer">
           ...
           <p className='m-0 mb-1'>Hazel</p>
            <div className='user1Msg'>
              <p>hello form hazel Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, illo.</p>
           ...
           <div className="user2 ">
            ...
            <div className='mt-1 me-3 w-100 '>
              ...
              <div className='user2Msg ms-auto text-start'>
                <p>hy from Lorem ipsum dolor laboriosam. influincer Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi delectus quae dolore in quam quaerat repellat dignissimos facere error quasi.</p>
              </div>
              </div>
            <div>
              <img src={profile} width={25} height={25} alt="" />
      ...
      filteredChatData.map((chat, index) => (
        <div
          ...
          style={{ backgroundColor: '#F6F6F6', borderRadius: '20px', cursor: 'pointer' }}
