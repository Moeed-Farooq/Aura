    ...
    <>
      <div className="main-container">
        <div className="container-fluid m-0 p-0 " style={{ height: "100%" }}>
          <div className="row  pt-4 px-4 d-flex" style={{ height: "50%" }}>
            <div className="col-md-4 ">
              ...
              >
                <div className="bg-white d-flex">
                  <div className="ms-2">
                    <img src={profile} className="influincerDataImg" alt="" />
                  </div>
            ...
            <div className="col-md-4  ">
              <div
                className="bg-white h-100 px-3 py-2 "
                style={{ borderRadius: "30px" }}
              >
                <p className="Influincersocialheading ms-1">
            ...
            <div
              className="col-md-4 pb-3 bg-white px-3 align-items-center "
              style={{
                borderRadius: "30px",
                height: "100%",
                position: "relative",
          ...
          <div className="row  m-0 p-0 " style={{ height: "50%" }}>
            <div className="col-md-8 mt-3 " style={{ height: "90%" }}>
              <div
            ...
            <div className="col-md-4 pe-2 m-0 p-0 " style={{ height: "87%" }}>
              <div
                className="bg-white influincerLikes mt-3 p-3"
              ...
              <div
                className="bg-white influincerLikes mt-2 p-3 "
                style={{ borderRadius: "30px", height: "50%" }}
              >
                <div className=" d-flex justify-content-between align-items-center">
                  <p>Total likes</p>
