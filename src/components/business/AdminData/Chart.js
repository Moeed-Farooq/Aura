...
const Chart = () => {
  ...
  return (
    <>
      <div className="row">
        ...
        <div className="col-md-2">
          <Link to="/completeOrder">
            <button className="chart-btn py-1 px-3">Completed</button>
          </Link>
        </div>
        <div className="col-md-2">
          <Link to="/cancelOrder">
            <button className="chart-btn py-1 px-3">Cancelled</button>
          </Link>
        </div>
        <div className="col-md-4 d-flex justify-content-end">
          <div className="dropdown w-100 pe-3 d-flex justify-content-end ">
            <button
              className="chart-btn px-3  py-1 w-75 dropdown-toggle"
              type="button"
      ...
      {/* chart */}
      <div className="chart-container pt-2" style={{ height: "100%" }}>
        <ResponsiveContainer width="100%" height="88%" className="pe-3">
          <BarChart data={data.slice(-monthsToDisplay)}>
